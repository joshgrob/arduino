...
/* constants just for these function.  Do not to expose in header file
* Define registry settings and global variables for functions.
*
 */
...
/*  Helper functions to get Mag, Gyro and Accel resolution values
 * 
 */
void getMres() {
    switch (Mscale) {
...
/*  functions to get Mag, Gyro and Accel data from MPU
 * 
 */
...
void getAccelData() {
    ...
    //todo form and return and struct with the data
}
...
/*  Functions to initialize and calibrate Magnometer
 * 
 */ 
...
boolean testMagConnection(){
  byte d = readByte(AK8963_ADDRESS, WHO_AM_I_AK8963);  // Read WHO_AM_I register for AK8963
    ...
    if (d == 0x48) { 
      ...
      Serial.print("Magnometer "); Serial.print("I AM "); Serial.print(d, HEX); Serial.print(" I should be "); Serial.println(0x48, HEX);
      return false;
    }
}
/*************************************************************/

/*  Functions to initialize and calibrate MPU
 * 
 */
void initMPU9250() {  
    // wake up device
...
void selfTestMPU() { // Start by performing self test and reporting values
...
void calibrateMPU() {
    ...
    if (MPU_DEBUG){
        Serial.print("x-axis calibration: acceleration : "); Serial.println(accelBias[0],1);
        Serial.print("y-axis calibration: acceleration : "); Serial.println(accelBias[1],1); 
        Serial.print("z-axis calibration: acceleration : "); Serial.println(accelBias[2],1);
        Serial.print("x-axis calibration: gyration : "); Serial.println(gyroBias[0],1);
        Serial.print("y-axis calibration: gyration : "); Serial.println(gyroBias[1],1);
        Serial.print("z-axis calibration: gyration : "); Serial.println(gyroBias[2],1);
    }
...
/*  Functions to do Quaternion Update        
 *         
 */
...
/*  Functions to do get Yaw, Pitch and Roll values        
